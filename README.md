...
0.18.0 is not assumed to exist on LuaRocks.org: `make lua-rock` installs it
from the official release source rock at
`https://github.com/sa6mwa/lonejson/releases/download/v0.18.0/lonejson-0.18.0-1.src.rock`
...
```sh
luarocks install https://github.com/sa6mwa/lonejson/releases/download/v0.18.0/lonejson-0.18.0-1.src.rock
