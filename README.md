...
0.16.0 is not assumed to exist on LuaRocks.org: `make lua-rock` installs it
...
```sh
luarocks install https://github.com/sa6mwa/lonejson/releases/download/v0.16.0/lonejson-0.16.0-1.src.rock
