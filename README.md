...
0.35.1 is not assumed to exist on LuaRocks.org: `make lua-rock` installs it
...
```sh
luarocks install https://github.com/sa6mwa/lonejson/releases/download/v0.35.1/lonejson-0.35.1-1.src.rock
