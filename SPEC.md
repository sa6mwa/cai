...
- Lua bindings for liblockdc and the downstream luas are available here, but I think :
  ...
  * https://github.com/sa6mwa/libpslog/releases/download/v0.4.0/lua-pslog-0.4.0-1.rockspec
  * https://github.com/sa6mwa/libpslog/releases/download/v0.4.0/lua-pslog-0.4.0-1.src.rock
