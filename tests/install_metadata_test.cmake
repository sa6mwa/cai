...
if(NOT DEFINED CAI_ABI_VERSION OR NOT CAI_ABI_VERSION STREQUAL "5")
  message(FATAL_ERROR "cai shared-library ABI must be 5")
endif()
...
if(installed_shared_library)
  ...
  if(NOT CAI_TARGET_ID MATCHES "darwin")
    if(EXISTS "${CAI_READELF}")
      ...
      if(NOT readelf_output MATCHES "SONAME[^\n]*libcai\\.so\\.5")
        message(FATAL_ERROR "installed libcai does not advertise ABI 5")
      endif()
