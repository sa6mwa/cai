...
static const cai_model_info cai_models[] = {
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_5, CAI_MODEL_CAP_TEXT_IMAGE, 1050000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_5_2026_04_23, CAI_MODEL_CAP_TEXT_IMAGE,
                  1050000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_5_PRO, CAI_MODEL_CAP_TEXT_IMAGE, 1050000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_5_PRO_2026_04_23, CAI_MODEL_CAP_TEXT_IMAGE,
                  1050000LL),
    ...
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_4_NANO_2026_03_17,
                  CAI_MODEL_CAP_TEXT_REALTIME, 400000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_2, CAI_MODEL_CAP_TEXT_IMAGE, 400000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_2_2025_12_11, CAI_MODEL_CAP_TEXT_IMAGE,
                  400000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_2_PRO, CAI_MODEL_CAP_TEXT_IMAGE, 400000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_2_PRO_2025_12_11, CAI_MODEL_CAP_TEXT_IMAGE,
                  400000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_1, CAI_MODEL_CAP_TEXT_IMAGE, 400000LL),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_1_2025_11_13, CAI_MODEL_CAP_TEXT_IMAGE,
                  400000LL),
    ...
    CAI_MODEL_ROW(CAI_MODEL_GPT_3_5_TURBO_16K_0613, CAI_MODEL_CAP_TEXT,
                  16385LL),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_GPT_5_3_CHAT_LATEST,
                          CAI_MODEL_CAP_TEXT_IMAGE),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_GPT_5_2_CHAT_LATEST,
                          CAI_MODEL_CAP_TEXT_IMAGE),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_GPT_5_1_CODEX, CAI_MODEL_CAP_TEXT_IMAGE),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_GPT_5_1_CODEX_MAX,
                          CAI_MODEL_CAP_TEXT_IMAGE),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_GPT_5_1_CHAT_LATEST,
                          CAI_MODEL_CAP_TEXT_IMAGE),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_GPT_5_CHAT_LATEST,
                          CAI_MODEL_CAP_TEXT_IMAGE),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_GPT_5_CODEX, CAI_MODEL_CAP_TEXT_IMAGE),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_GPT_5_PRO, CAI_MODEL_CAP_TEXT_IMAGE),
