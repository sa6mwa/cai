...
#define CAI_MODEL_CAP_TEXT_IMAGE_REASONING                                     \
  (CAI_MODEL_CAP_TEXT_IMAGE | CAI_MODEL_CAP_REASONING)
#define CAI_MODEL_CAP_TEXT_IMAGE_REASONING_PRO_MODE                            \
  (CAI_MODEL_CAP_TEXT_IMAGE_REASONING | CAI_MODEL_CAP_REASONING_PRO_MODE)
#define CAI_MODEL_CAP_TEXT_REALTIME_REASONING                                  \
  (CAI_MODEL_CAP_TEXT_REALTIME | CAI_MODEL_CAP_REASONING)
#define CAI_MODEL_CAP_TEXT_IMAGE_NO_STRUCTURED_REASONING                       \
  (CAI_MODEL_CAP_TEXT_IMAGE_NO_STRUCTURED | CAI_MODEL_CAP_REASONING)
#define CAI_MODEL_CAP_TEXT_IMAGE_NO_STREAM_REASONING                           \
  (CAI_MODEL_CAP_TEXT_IMAGE_NO_STREAM | CAI_MODEL_CAP_REASONING)
...
static const cai_model_info cai_models[] = {
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_6_ASTRA, CAI_MODEL_CAP_TEXT_IMAGE_REASONING_PRO_MODE,
        1050000LL, 10.00, 1.00, 50.00, 272000LL, 20.00, 2.00, 75.00),
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_6_LUNA, CAI_MODEL_CAP_TEXT_IMAGE_REASONING_PRO_MODE,
        1050000LL, 0.10, 0.01, 0.50, 272000LL, 0.20, 0.02, 0.75),
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_5_6, CAI_MODEL_CAP_TEXT_IMAGE_REASONING_PRO_MODE,
        1050000LL, 5.00, 0.50, 30.00, 272000LL, 10.00, 1.00, 45.00),
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_5_6_SOL, CAI_MODEL_CAP_TEXT_IMAGE_REASONING_PRO_MODE,
        1050000LL, 5.00, 0.50, 30.00, 272000LL, 10.00, 1.00, 45.00),
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_5_6_TERRA, CAI_MODEL_CAP_TEXT_IMAGE_REASONING_PRO_MODE,
        1050000LL, 2.00, 0.20, 12.00, 272000LL, 4.00, 0.40, 18.00),
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_5_6_LUNA, CAI_MODEL_CAP_TEXT_IMAGE_REASONING_PRO_MODE,
        1050000LL, 0.20, 0.02, 1.20, 272000LL, 0.40, 0.04, 1.80),
    CAI_MODEL_ROW_PRICED_LONG(CAI_MODEL_GPT_5_5,
                              CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 1050000LL,
                              5.00, 0.50, 30.00, 272000LL, 10.00, 1.00, 45.00),
    CAI_MODEL_ROW_PRICED_LONG(CAI_MODEL_GPT_5_5_2026_04_23,
                              CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 1050000LL,
                              5.00, 0.50, 30.00, 272000LL, 10.00, 1.00, 45.00),
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_5_5_PRO,
        CAI_MODEL_CAP_TEXT_IMAGE_NO_STREAM | CAI_MODEL_CAP_REASONING, 1050000LL,
        30.00, 30.00, 180.00, 272000LL, 60.00, 60.00, 270.00),
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_5_5_PRO_2026_04_23,
        CAI_MODEL_CAP_TEXT_IMAGE_NO_STREAM | CAI_MODEL_CAP_REASONING, 1050000LL,
        30.00, 30.00, 180.00, 272000LL, 60.00, 60.00, 270.00),
    CAI_MODEL_ROW_PRICED_LONG(CAI_MODEL_GPT_5_4,
                              CAI_MODEL_CAP_TEXT_REALTIME_REASONING, 1050000LL,
                              2.50, 0.25, 15.00, 272000LL, 5.00, 0.50, 22.50),
    CAI_MODEL_ROW_PRICED_LONG(
        CAI_MODEL_GPT_5_4_PRO, CAI_MODEL_CAP_TEXT_IMAGE_NO_STRUCTURED_REASONING,
        1050000LL, 30.00, 30.00, 180.00, 272000LL, 60.00, 60.00, 270.00),
    CAI_MODEL_ROW_PRICED_LONG(CAI_MODEL_GPT_5_4_PRO_2026_03_05,
                              CAI_MODEL_CAP_TEXT_IMAGE_NO_STRUCTURED_REASONING,
                              1050000LL, 30.00, 30.00, 180.00, 272000LL, 60.00,
                              60.00, 270.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_4_MINI,
                         CAI_MODEL_CAP_TEXT_REALTIME_REASONING, 400000LL, 0.75,
                         0.075, 4.50),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_4_NANO,
                         CAI_MODEL_CAP_TEXT_REALTIME_REASONING, 400000LL, 0.20,
                         0.02, 1.25),
    ...
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_4_NANO_2026_03_17,
                         CAI_MODEL_CAP_TEXT_REALTIME_REASONING, 400000LL, 0.20,
                         0.02, 1.25),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_3_CODEX,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 400000LL, 1.75,
                         0.175, 14.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_CHAT_LATEST, CAI_MODEL_CAP_TEXT_IMAGE,
                         400000LL, 5.00, 0.50, 30.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_2, CAI_MODEL_CAP_TEXT_IMAGE_REASONING,
                         400000LL, 1.75, 0.175, 14.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_2_2025_12_11,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 400000LL, 1.75,
                         0.175, 14.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_2_PRO,
                         CAI_MODEL_CAP_TEXT_IMAGE_NO_STRUCTURED_REASONING,
                         400000LL, 21.00, 21.00, 168.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_2_PRO_2025_12_11,
                         CAI_MODEL_CAP_TEXT_IMAGE_NO_STRUCTURED_REASONING,
                         400000LL, 21.00, 21.00, 168.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_1, CAI_MODEL_CAP_TEXT_IMAGE_REASONING,
                         400000LL, 1.25, 0.125, 10.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_1_2025_11_13,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 400000LL, 1.25,
                         0.125, 10.00),
    CAI_MODEL_ROW(CAI_MODEL_GPT_5_1_MINI, CAI_MODEL_CAP_TEXT_IMAGE_REASONING,
                  400000LL),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5, CAI_MODEL_CAP_TEXT_REALTIME_REASONING,
                         400000LL, 1.25, 0.125, 10.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_MINI,
                         CAI_MODEL_CAP_TEXT_REALTIME_REASONING, 400000LL, 0.25,
                         0.025, 2.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_NANO,
                         CAI_MODEL_CAP_TEXT_REALTIME_REASONING, 400000LL, 0.05,
                         0.005, 0.40),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_2025_08_07,
                         CAI_MODEL_CAP_TEXT_REALTIME_REASONING, 400000LL, 1.25,
                         0.125, 10.00),
    ...
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_4_1_NANO_2025_04_14,
                         ...
                         0.40),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_O4_MINI, CAI_MODEL_CAP_TEXT_IMAGE_REASONING,
                         200000LL, 1.10, 0.275, 4.40),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_O4_MINI_2025_04_16,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 200000LL, 1.10,
                         0.275, 4.40),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_O3, CAI_MODEL_CAP_TEXT_IMAGE_REASONING,
                         200000LL, 2.00, 0.50, 8.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_O3_2025_04_16,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 200000LL, 2.00,
                         0.50, 8.00),
    CAI_MODEL_ROW(CAI_MODEL_O3_MINI,
                  CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING, 200000LL),
    CAI_MODEL_ROW(CAI_MODEL_O3_MINI_2025_01_31,
                  CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING, 200000LL),
    CAI_MODEL_ROW(CAI_MODEL_O1, CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING,
                  200000LL),
    CAI_MODEL_ROW(CAI_MODEL_O1_2024_12_17,
                  CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING, 200000LL),
    CAI_MODEL_ROW(CAI_MODEL_O1_PREVIEW,
                  CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING, 128000LL),
    CAI_MODEL_ROW(CAI_MODEL_O1_PREVIEW_2024_09_12,
                  CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING, 128000LL),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_O1_MINI,
                         CAI_MODEL_CAP_RESPONSES | CAI_MODEL_CAP_STREAMING |
                             CAI_MODEL_CAP_REASONING,
                         128000LL, 1.10, 0.55, 4.40),
    CAI_MODEL_ROW_META_PRICED(
        CAI_MODEL_O1_MINI_2024_09_12,
        CAI_MODEL_CAP_RESPONSES |
            CAI_MODEL_CAP_STREAMING | CAI_MODEL_CAP_REASONING,
        CAI_MODEL_META_VERIFIED | CAI_MODEL_META_DEPRECATED, 128000LL, 1.10,
        0.55, 4.40),
    ...
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_2_CHAT_LATEST,
                         ...
                         14.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_1_CODEX,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 400000LL, 1.25,
                         0.125, 10.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_1_CODEX_MAX,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 400000LL, 1.25,
                         0.125, 10.00),
    ...
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_CHAT_LATEST, CAI_MODEL_CAP_TEXT_IMAGE,
                         400000LL, 1.25, 0.125, 10.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_CODEX,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 400000LL, 1.25,
                         0.125, 10.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_PRO,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 400000LL, 15.00,
                         15.00, 120.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_GPT_5_PRO_2025_10_06,
                         CAI_MODEL_CAP_TEXT_IMAGE_REASONING, 400000LL, 15.00,
                         15.00, 120.00),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_O1_PRO,
                          CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_O1_PRO_2025_03_19,
                          CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_O3_PRO,
                         CAI_MODEL_CAP_TEXT_IMAGE_NO_STREAM_REASONING, 200000LL,
                         20.00, 20.00, 80.00),
    CAI_MODEL_ROW_PRICED(CAI_MODEL_O3_PRO_2025_06_10,
                         CAI_MODEL_CAP_TEXT_IMAGE_NO_STREAM_REASONING, 200000LL,
                         20.00, 20.00, 80.00),
    CAI_MODEL_ROW_UNKNOWN(CAI_MODEL_O3_DEEP_RESEARCH,
                          CAI_MODEL_CAP_TEXT | CAI_MODEL_CAP_REASONING),
    ...
    CAI_MODEL_ROW_META_PRICED(
        ...
        CAI_MODEL_META_DEPRECATED | CAI_MODEL_META_PROVIDER_OPENROUTER,
        131072LL, 0.0, 0.0, 0.0),
    ...
    CAI_MODEL_ROW_META_PRICED(
        ...
        CAI_MODEL_CAP_RESPONSES |
            CAI_MODEL_CAP_STREAMING | CAI_MODEL_CAP_FUNCTION_CALLING,
        CAI_MODEL_META_VERIFIED | CAI_MODEL_META_PROVIDER_OPENROUTER, 262144LL,
        0.0, 0.0, 0.0),
    CAI_MODEL_ROW_META_PRICED_LONG(
        CAI_OPENROUTER_MODEL_OPENAI_GPT_5_6_LUNA,
        CAI_MODEL_CAP_TEXT_IMAGE_REASONING_PRO_MODE,
        CAI_MODEL_META_VERIFIED | CAI_MODEL_META_PROVIDER_OPENROUTER, 1050000LL,
        0.20, 0.02, 1.20, 272000LL, 0.40, 0.04, 1.80),
